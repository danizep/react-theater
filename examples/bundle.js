...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Theater = __webpack_require__(7);

	var _Theater2 = _interopRequireDefault(_Theater);

	var _TheaterImage = __webpack_require__(8);

	var _TheaterImage2 = _interopRequireDefault(_TheaterImage);

	var _TheaterSideContent = __webpack_require__(9);

	var _TheaterSideContent2 = _interopRequireDefault(_TheaterSideContent);
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                _Theater2.default,
	                _extends({}, this.state, { onClose: this._handleClose, onNext: this._handleNext, onPrev: this._handlePrev, preloadEnabled: false }),
	                _react2.default.createElement(_TheaterImage2.default, { content: true }),
	                _react2.default.createElement(_TheaterSideContent2.default, { content: false })
	            ),
	            this.props.items.map(function (item, key) {
	                return _react2.default.createElement('img', { src: item, s: true,
	                    className: 'cat',
	                    key: 'cat' + key,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Theater = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        var _splitChildren = this._splitChildren();

	        var content = _splitChildren.content;
	        var sideContent = _splitChildren.sideContent;
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.cloneElement(content, { item: this.props.items[this.props.currentItem] })
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'theater-side-content' },
	                        _react2.default.cloneElement(sideContent, { item: this.props.currentItem })
	                    )
	                )
	            )
	        );
	    ...
	    _getPreloadHtml: function _getPreloadHtml(content) {
	        if (this.props.preloadEnabled) {
	            return _react2.default.createElement(
	                'div',
	                { className: 'theater-preload' },
	                _react2.default.cloneElement(content, { item: this.props.items[this.props.currentItem - 1] }),
	                _react2.default.cloneElement(content, { item: this.props.items[this.props.currentItem + 1] })
	            );
	        }
	    },
	    ...
	    _handleToggleDisableScroll: function _handleToggleDisableScroll() {
	    ...
	    _splitChildren: function _splitChildren() {
	        var children = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TheaterImage = _react2.default.createClass({
	    displayName: 'TheaterImage',
	    getInitialState: function getInitialState() {
	        return {
	            item: null
	        };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TheaterSideContent = _react2.default.createClass({
	    displayName: 'TheaterSideContent',
	    getInitialState: function getInitialState() {
	        return {
	            item: null
	        };
	...
	exports.default = TheaterSideContent;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactVersion = __webpack_require__(21);

	var findDOMNode = __webpack_require__(22);
	var renderSubtreeIntoContainer = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDOMServer = __webpack_require__(25);
	var ReactIsomorphic = __webpack_require__(24);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var validateDOMNesting = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInstanceHandles = __webpack_require__(16);
	var ReactMount = __webpack_require__(17);
	var ReactReconcileTransaction = __webpack_require__(58);
	var SelectEventPlugin = __webpack_require__(59);
	var ServerReactRootIndex = __webpack_require__(60);
	var SimpleEventPlugin = __webpack_require__(61);
	var SVGDOMPropertyConfig = __webpack_require__(62);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCurrentOwner = __webpack_require__(13);
	var ReactDOMFeatureFlags = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventPropagators = __webpack_require__(97);
	var ReactMount = __webpack_require__(17);
	var SyntheticClipboardEvent = __webpack_require__(110);
	var SyntheticEvent = __webpack_require__(98);
	var SyntheticFocusEvent = __webpack_require__(111);
	var SyntheticKeyboardEvent = __webpack_require__(112);
	var SyntheticMouseEvent = __webpack_require__(105);
	var SyntheticDragEvent = __webpack_require__(113);
	var SyntheticTouchEvent = __webpack_require__(114);
	var SyntheticUIEvent = __webpack_require__(115);
	var SyntheticWheelEvent = __webpack_require__(116);
